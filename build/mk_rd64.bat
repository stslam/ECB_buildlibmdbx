...
:: -fno-inline : Отключить инлайнинг функций (чтобы дебюггер не терял переменные)
...
SET "PRJDIR=E:\NewQDB\PLAYGROUND\LIBMDBX_MASTER\libmdbx-master\libmdbx-master"
SET "OUTDIR=%PRJDIR%\OUT\Win64\%BUILD_TYPE%"
